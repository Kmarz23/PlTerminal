                ...
                if latest_version:
                    if latest_version > current_version:
                        ...
                        if odp == 'T' or odp ==  't':
                        	...
                        	os.system(f"rm ~/PlTerminal-Termux.py")
                        	os.system(f"cp PlTerminal-{latest_version}/PlTerminal-Termux.py ~")
                        	os.system("clear")
...
def pp_i():
    try:
        ...
        os.system(f"pkg install {pakiet}")
...
def main():
    print("Witaj w polskiej nakładce dla Termux!")
    print("Wersja:", wersja, "\n")
